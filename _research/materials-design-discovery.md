...
* Computationally discovered the design principle of face-sharing high-coordination sites for fast Na-ion conduction by applying it to discover the UCl3-type Na<sub>x</sub>M<sub>y</sub>Cl<sub>6</sub> (M = La–Sm) chloride family with conductivities <span class="citation">[*Nat. Commun.* 14, 7615 (2023)](https://doi.org/10.1038/s41467-023-43436-3)</span> **→** experimentally validated as a Na-ion conductor of ~1–2 mS/cm (highest in Na halide) <span class="citation">[*Adv. Mater.* 36, 230812 (2024)](https://doi.org/10.1002/adma.202308012)</span>, and confirmed to also enable fast Li-ion conduction <span class="citation">[*J. Am. Chem. Soc.* 145, 2183-2194 (2023)](https://doi.org/10.1021/jacs.2c09446)</span>
