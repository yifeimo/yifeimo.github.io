...
<br><span class="citation" style="display: block; margin-left: 2.2em;">Shows that MLIPs trained on limited phases often fail to transfer to the diverse compositions, lattice structures, and elemental orderings of alloys, and introduces energy-ranking metrics for the relative stability of complex orderings—important for alloy thermodynamics, defect equilibria, and phase-diagram prediction. [Code](https://github.com/mogroupumd/Li-Al_MLIP_datasets)</span>
